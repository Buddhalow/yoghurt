...
var Windows95Style = function (_Style) {
    ...
    _createClass(Windows95Style, [{
        ...
        value: function renderButton(gc, control) {
            // Draws button
            gc.setFont(control.font);
            var textPositionX = control.x + control.width / 2 - gc.measureText(control.text).width / 2;
            var textPositionY = control.y + control.height / 2 - control.font.size / 2 + 2;
        ...
        value: function renderControl(gc, control) {
            ...
            try {
                for (var _iterator2 = Object.values(control.controls)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
